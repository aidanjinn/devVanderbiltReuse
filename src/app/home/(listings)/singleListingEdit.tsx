...
export default function SingleListingEdit({
  listing,
  refetchListings,
}: {
  listing: Listing;
  ...
  return (
    <>
      ...
      />
      <div
        style={{ height: "16em", width: "13em" }}
        className="cursor-pointer center flex-col rounded bg-gray-300 p-3"
      >
        <div
          style={{
            width: "9em",
        ...
        <Group>
          <Button variant="light" onClick={handleViewOpen}>
            Preview
          </Button>
